...
# attribute keys:
###################################################
LABEL_KEY = "label"  #: The label that is used in the UI this attribute definition
TYPE_KEY = "type"  #: Selects the type of an attribute definition
TOOLTIP_KEY = "tooltip"  #: Displays a tooltip with additional information about this attribute definition
INHERIT_KEY = "inherit"  #:
