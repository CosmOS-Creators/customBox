            ...
            for sectionID, userSection in user_sections:
                if sectionID in ForbiddenSectionNames:
                    raise AttributeError(
                        f'A section id with the name "{sectionID}" was requested but this ID is a reserved keyword and thus cannot be used as a section name.'
                    )
