...
class configGenerator():
	def __init__(self, workspace: Parser.Workspace):
		...
		self.FileCleaner 		= GeneratorPlugins.fileCleanerPlugin([workspace.ApplicationGeneratedDir, workspace.CoreGeneratedDir])

		self.logicRunnerPlugin.registerLogic([InitializerLogic(), MemoryMapperLogic(), PermissionerLogic(), SchedulerLogic()])
